...
type OrderInfo struct {
	...
	UserId         int        `json:"user_id" gorm:"type:int(64);DEFAULT NULL; COMMENT:'用户ID'"`
	Product        int        `json:"user_id" gorm:"type:int(64);DEFAULT NULL; COMMENT:'产品ID'"`
	DeliveryAddrId int        `json:"delivery_addr_id" gorm:"type:int(64);DEFAULT NULL;COMMENT:'收获地址ID'"`
